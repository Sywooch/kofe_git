    ...
    <aside class="complain">
        <div class="complain__inner">
            <div class="complain__box">
                ...
                <p class="complain__text">Если поломка произошла внезапно и вносит проблемы в Ваш быт, мы можем устранить её в кратчайшие сроки. Наш курьер заберёт неисправную кофемашину с любого района <?= str_replace(' и область', '', Yii::$app->session['region']['title']); ?> и максимально быстро доставит её в СЦ для ремонта.</p>
