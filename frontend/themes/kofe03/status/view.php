            ...
            <main class="content__main" role="main">
                <article class="post" style="width: 100%;">
                    ...
                    <div class="post__content">
                        <div class="post__content">
                            <ul>
                                <li>Для получения оперативной информации о статусе ремонта вашей кофемашины, позвоните на номер <a class="<?= isset($siteConfig['spb']) && $siteConfig['spb'] ? 'telfix' : 'tel03' ?>" href="tel:<?= preg_replace("/\D/", "", Yii::$app->session['region']['phone']); ?>"><?= Yii::$app->session['region']['phone']; ?></a> или заполните нижеследующую форму:</li>
                            </ul>
                            <?php
