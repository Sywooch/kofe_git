    ...
    <aside class="poster" style="background-image: url(<?= $assets . $siteConfig['theme'] . '/'; ?>images/poster_1.jpg);">
        <div class="poster__inner">
            <div class="poster__request">
                <form class="form form_request callback" id="" action="http://remrus.ru/" method="POST">
                    ...
                    <div class="form__box">
                        ...
                        <div class="form__row form__row_submit">
                            <input name="submit2" id="tmpIdButton3" class="button button_warning button_wide button_big button_text" type="submit" value="Вызвать курьера"/>
                        </div>
                ...
                <form class="form form_request_full form_hidden callback" id="callMasterFull" action="#">
                    <input type="hidden" value='{"host":"remrus.ru","name":"Главная"}' name="TrafficSource">
                    <input type="hidden" value='{"utm_phone":"74952284282","utm_content":"","utm_source":"seo"}' name="utm_form_value">
                    <div class="form__box">
                        ...
                        <div class="form__row">
                            <label class="form__element form__element_input form__element_valid">
                                <input class="form__input form__input_phone-mask form__input_phone" name="values[Телефон]" placeholder="+7 (___) ___-__-__" required>
                            </label>
                            <label class="form__element form__element_input">
                                <input class="form__input form__input_name" name="values[Имя]" placeholder="Имя">
                            </label>
                            <label class="form__element form__element_input">
                                <input class="form__input form__input_email" type="email" name="email" placeholder="Email">
                            </label>
                        </div>
                        <div class="form__row">
                            <label class="form__element form__element_input">
                                <input class="form__input form__input_address" name="address" placeholder="Адрес">
                            </label>
                            <label class="form__element form__element_input">
                                <input class="form__input form__input_repair" name="values[Подробности]" placeholder="Что чинить?">
                            </label>
                        </div>
                        <div class="form__row form__row_submit">
                            <button id="tmpIdButton2" class="button button_success button_text" type="submit">Дополнить заявку</button>
                        </div>
                    </div>
                </form>
                <div class="form form_request_success form_hidden">
                    <div class="form__box">
