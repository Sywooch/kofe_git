                        ...
                        <!--<ul>
                            <div class="container">
                                <?php foreach ($row['children'] as $model): ?>
                                    <li><a class="colorborder" href="/<?= $model['url']; ?>"><img src="<?= $assets ?>/multicatspb/uploads/images/<?= $model['image']; ?>"><span>Ремонт</span><?= $model['title']; ?></a></li>
                                <?php endforeach; ?>
                            </div>
                        </ul>-->
                    <?php endif; ?>
