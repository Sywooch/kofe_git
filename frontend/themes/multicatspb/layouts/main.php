...
<html lang="ru">
    <head>  
        ...
        <link rel="stylesheet" href="<?= $assets ?>/multicatspb/css/main.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/multicatspb/css/animate.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/multicatspb/css/owl.carousel.min.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/multicatspb/css/owl.theme.default.min.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/multicatspb/css/font-awesome.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/multicatspb/css/horizontal.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/multicatspb/css/colors.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/multicatspb/css/<?= \app\components\CController::$monoBrand['url']; ?>.css" type="text/css" />
    ...
    <body id="index" class="index <?= \app\components\CController::$monoBrand['url']; ?>">
        ...
        <?= multicatspb\widgets\menu\MainMenu::widget(); ?>
        <?php
        ...
        <footer class="colorborder">
            <div class="container">
                    ...
                    <div class="right">
                        ...
                        <div class="content">
                            ...
                            <div id="local1" class="footer-map active">
                                <div class="info">
                                    <div class="img"><img src="<?= $assets ?>/multicatspb/images/<?= \app\components\CController::$monoBrand['url']; ?>.jpg" alt=""></div>
                                    <div class="text">
                ...
                <div class="bottom-menu">
                    <div class="logo">
                        <img src="<?= $assets ?>/multicatspb/images/<?= \app\components\CController::$monoBrand['url']; ?>2.svg">
        ...
        <div class="popup">
            <div id="popup1" class="inner">
                <div class="left" style="background-image: url(<?= $assets ?>/multicatspb/images/popupbgmaster.jpg);"></div>
                <div class="right start">
                    ...
                    <?= multicatspb\widgets\forms\Order::widget(['id' => 'order-form2']); ?>
                </div>
                <div class="right finish">
                    <i class="close"></i>
                    <div class="thanku">
                        <img src="<?= $assets ?>/multicatspb/images/icon/check.svg">
            ...
            <div id="popup2" class="inner">
                <div class="left" style="background-image: url(<?= $assets ?>/multicatspb/images/popupbg.jpg"></div>
                <div class="right start">
                    <i class="close"></i>
                    <div class="title">Записаться на ремонт</div>
                    <p>Мы производим любой ремонт техники Apple, начиная с замены компонентов и заканчивая пайкой и ремонтом материнских плат. В нашем Сервисном Центре можно решить практически любые проблемы!</p>
                    <?= multicatspb\widgets\forms\Order::widget(); ?>
                </div>
                <div class="right finish">
                    <i class="close"></i>
                    <div class="thanku">
...
<script src="<?= $assets ?>/multicatspb/js/jquery-1.11.3.min.js"></script>
<script src="<?= $assets ?>/multicatspb/js/jquery.sticky.js"></script>
<script src="<?= $assets ?>/multicatspb/js/owl.carousel.min.js"></script>
<script src="<?= $assets ?>/multicatspb/js/jquery.inputmask.bundle.js"></script>
<script src="<?= $assets ?>/multicatspb/js/horizontal.js"></script>
<script src="<?= $assets ?>/multicatspb/js/plugins.js"></script>
<script src="<?= $assets ?>/multicatspb/js/sly.min.js"></script>
<script src="<?= $assets ?>/multicatspb/js/wow.js"></script>
<script src="<?= $assets ?>/multicatspb/js/jquery.fancybox.pack.js"></script>
<script src="<?= $assets ?>/multicatspb/js/yii.activeForm.js"></script>
<script src="<?= $assets ?>/multicatspb/js/yii.js"></script>
<script src="<?= $assets ?>/multicatspb/js/yii.validation.js"></script>
<script>
                                    new WOW().init();
</script>
...
<script src="<?= $assets ?>/multicatspb/js/main.js?v=5"></script>
<?php
