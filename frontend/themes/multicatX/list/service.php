            ...
            <div class="product-category-left-info">
                ...
                <div class="category-info">
                    <?php if (!empty($pageInfo['description'])): ?>
                        <?php
                        if (!empty($page) && $page['type'] == 'model')
                            echo str_replace('#model_en#', \app\components\CController::$monoBrand['title'] . ' ' . $pageInfo['title'], $pageInfo['description']);
                        elseif (!empty($page) && $page['type'] == 'brand') {
                            echo str_replace('#brand_en#', \app\components\CController::$monoBrand['title'], $pageInfo['description']);
                        }
                        ?>
                    <?php else: ?>
