            ...
            <div class="row">
                <div class="col-xs-12">
                    <ol itemscope itemtype="http://schema.org/BreadcrumbList" class="breadcrumb">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span itemscope="" itemtype="http://schema.org/Thing" itemprop="item"><?= $pageInfo['title']; ?></span> <meta itemprop="position" content="2" /></li>
                    </ol>
                </div>
                <div class="col-xs-9">
                    <div class="row">
