            ...
            <div class="row">
                <div class="col-xs-12">
                    <ol itemscope itemtype="http://schema.org/BreadcrumbList" class="breadcrumb">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemscope itemtype="http://schema.org/Thing" itemprop="item" href="/<?= $brand['url']; ?>"><span itemprop="name"><?= $brand['title']; ?></span></a><meta itemprop="position" content="1" /></li>
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span itemscope="" itemtype="http://schema.org/Thing" itemprop="item"><span itemprop="name"><?= $pageInfo['title']; ?></span></span> <meta itemprop="position" content="2" /></li>
                    </ol>
                </div>
                <div class="col-xs-9">
                    <div class="row">
