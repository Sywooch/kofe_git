    ...
    <section class="breadcrumbs">
        <div class="row">
            <ol itemscope itemtype="http://schema.org/BreadcrumbList" class="breadcrumb">
                ...
                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span itemscope="" itemtype="http://schema.org/Thing" itemprop="item">Контактная информация</span> <meta itemprop="position" content="1" /></li>
            </ol>
        </div>
        <div class="row">
