                        ...
                        <div class="container">
                            <ul class="top_menu_big">
                                ...
                                <?php if ($siteConfig['id'] == 51) : ?>
                                    <li class="vk"><a target="_blank" href="https://vk.com/remontkofemashin_coffeehelp">Мы в: <img src="<?= $assets . $siteConfig['theme'] . '/'; ?>images/vk.svg" alt=""></a></li>
                                    <li class="vk"><a target="_blank" href="https://www.instagram.com/coffee_help/"><img src="<?= $assets . $siteConfig['theme'] . '/'; ?>images/instagram.svg" alt=""></a></li>
                                <?php endif; ?>
                            </ul>
