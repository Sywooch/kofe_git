...
<html>   
    <head>
        ...
        <link rel="stylesheet" href="<?= $assets . $siteConfig['theme'] . '/'; ?>css/main.css?v=13">
        <link rel="stylesheet" href="<?= $assets . $siteConfig['theme'] . '/'; ?>css/main2.css?v=13">        
        <link type="text/css" href="<?= $assets . $siteConfig['theme'] . '/'; ?>css/jquery-ui.css" rel="stylesheet" media="all" />
        <link href="<?= $assets . $siteConfig['theme'] . '/'; ?>css/<?= $siteConfig['id']; ?>.css?v=13" rel="stylesheet">
    </head>
    <body role="document">
        <?php
                    ...
                    <div class="row row_top_menu">
                        <div class="container">
                            <ul class="top_menu_big">
                                ...
                                <?php if ($siteConfig['id'] == 51) : ?><li class="vk"><a target="_blank" href="https://vk.com/remontkofemashin_coffeehelp">Мы в: <img src="<?= $assets . $siteConfig['theme'] . '/'; ?>images/vk.svg" alt=""></a></li><?php endif; ?>
                                <?php if ($siteConfig['id'] == 51) : ?><li class="instagram"><a target="_blank" href="https://www.instagram.com/coffee_help/">Мы в: <img src="<?= $assets . $siteConfig['theme'] . '/'; ?>images/instagram.svg" alt=""></a></li><?php endif; ?>
                            </ul>
