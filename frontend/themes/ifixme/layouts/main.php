...
<html lang="ru">
    <head>  
        ...
        <link rel="stylesheet" href="<?= $assets ?>/ifixme/css/main.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/ifixme/css/animate.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/ifixme/css/owl.carousel.min.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/ifixme/css/owl.theme.default.min.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/ifixme/css/font-awesome.css" type="text/css" />
        <link rel="stylesheet" href="<?= $assets ?>/ifixme/css/horizontal.css" type="text/css" />
...
<script src="<?= $assets ?>/ifixme/js/main.js"></script>
<?php
