    ...
    <section class="default margin--bottom0">
        <div class="row">
            <div class="col-md-3 hidden-sm hidden-xs">
                <?= helper\widgets\lists\PopularServices::widget(['view' => 'popularServicesMenu', 'type' => 2, 't1' => 'Неисправность']); ?>
            </div>
            <div class='col-md-1 hidden-sm hidden-xs'></div>
            <div class="col-md-8 col-sm-12 col-xs-12">                
                <?= helper\widgets\lists\PopularServices::widget(['view' => 'popularServicesTable', 'type' => 1, 't1' => 'Стоимость услуг', 't2' => 'Посмотреть все|Скрыть', 't3' => 'Посмотреть все', 'col' => false]); ?>
