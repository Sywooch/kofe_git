<div class="brend-tabs">
    ...
    <div id="tab-text-1" class="Toliq-tekst tab_content">
        <div class="kantener">
            <?php if (!empty($pageInfo['full_description'])): ?>
    ...
    <?php if (!empty($error['description'])): ?>
        <div id="tab-text-2" class="Toliq-tekst tab_content">
            <div class="kantener">
                <?= $error['description']; ?>
                <br>
            </div>
    ...
    <div class="button-section">
        <div class="kantener">
            <a class="knopkacha opan-all-models" href="#">Все модели <?= $pageInfo['title']; ?></a>
        </div>
    </div>
