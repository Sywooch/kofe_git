...
?><div class="kantener glavniy-osobinnisti">
    <div class="futures">
...
<div class="Ww-row" style="padding: 0; margin: 0; height: 6px; background: url('<?= $assets . $siteConfig['theme'] . '/'; ?>images/path-bg.jpg') top repeat-x; height: 6px; "></div>