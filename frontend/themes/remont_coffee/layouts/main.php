...
<html>    
    ...
    <body>
       <!-- <div style="display: none;" class="aksiya-popupic">
        ...
        <?php $this->beginBody() ?>
        <div class="kantener boshi">
            <div class="Ww-row Lagatip-lin">
                <div class="Lagatip-rasim">
        ...
        <div class="menushka">
            <div class="kantener boshi">
                <div class=" Menushka-linya">
                    <nav class="navbahor Navbahor-oddiy navbahor1">
                        <div class="Na-bar-bosh Nav-tele-uch">
                            <button type="button" class="Navbahor-togg clapsd" data-toggle="collapse" data-target="#main-menu" aria-expanded="false">
                                <span class="Sw-faqat">Toggle navigation</span>
                                <span class="Ikonka-bar"></span>
                                <span class="Ikonka-bar"></span>
                                <span class="Ikonka-bar"></span>
                            </button>
                            <a class="<?= isset($siteConfig['spb']) && $siteConfig['spb'] ? 'telefon-spb' : 'telefon-msk' ?>" href="tel:<?= preg_replace("/\D/", "", Yii::$app->session['region']['phone']); ?>"><?= Yii::$app->session['region']['phone']; ?></a>
                        </div>
                        <div class="clps Nvb-clps navbahor1" id="main-menu">
                            <ul id="menu-home" class="navv Nvb-navv">
        ...
        if (!Yii::$app->user->isGuest) {
            echo '<div style="float: left; z-index: 99999;position: absolute;" class="kantener">';
        ...
        <div class="Gc-pad">
            <div class="kantener">
                <div class="navbahor1 information">
                    <div class="Rasim-logo">
