...
<html lang="ru">
    <head>
        ...
        <link href="<?= $assets . $siteConfig['theme'] . '/'; ?>css/<?php if ($siteConfig['id'] == 125): ?>spb<?php endif; ?>main.css?=v17" rel="stylesheet" />
    </head>
...
<script src="<?= $assets . $siteConfig['theme'] . '/'; ?>js/app.min.js?v=6"></script>
<?php
