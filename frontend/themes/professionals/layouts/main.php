...
<html lang="ru">
    <head>
        ...
        <link href="<?= $assets . $siteConfig['theme'] . '/'; ?>css/<?php if ($siteConfig['id'] == 125): ?>spb<?php endif; ?>main.css?=v19" rel="stylesheet" />
    </head>
...
<script src="<?= $assets . $siteConfig['theme'] . '/'; ?>js/app.min.js?v=8"></script>
<?php
