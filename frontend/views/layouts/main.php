...
<html lang="en"> 
    <head>  
        ...
        <link rel="stylesheet" async href="<?= $assets ?>/<?= $siteConfig['sitePrefix']; ?>css/<?= $siteConfig['sitePrefix']; ?>all.css?v=19" type="text/css" />
        ...
        <style>#banner h2, #banner h3 {font-family: "NeuronExtraBold",cursive;clear: both;padding-top: 15px;margin: 0px;}#banner p {font-size: 15px;float: left;clear: both;margin-bottom: 15px;}</style>
    </head>    
