        ...
        <?php if ($isHome): ?>
            ...
            <div class="popup politica-info animated">
                <div class="wight">
                    ...
                    <div class="full-text">
                        <p>Настоящая Политика конфиденциальности действует в отношении всей информации, которую Сервисный центр, расположенный по адресу в сети Интернет <a class="spb-mobepolitica" href="http://repair-mobiles.ru">repair-mobiles.ru</a> (далее - Сайт), может получить о Пользователе во время использования сайта Сервисного центра, и является публичной офертой на основании 437 Гражданского кодекса Российской Федерации.</p>
                        <h4>1. &nbsp;Определение терминов</h4>
                        <p>1.1. «Персональные данные» - любая информация, прямо или косвенно касающаяся определенного физического лица (субъекта персональных данных). К данной категории информации отнесены ФИО, контактный телефон, адрес доставки, платежные реквизиты и другие данные, передаваемые Пользователем - Сервисному центру.</p>
                        <p>1.2. «Сервисный центр» - Администрация, занимающаяся обеспечением его функционирования; сотрудники, ответственные за управление сайтом, сбор, обработку и прочие операции, совершаемые с персональными данными.</p>
                        <p>1.3. «Обработка персональных данных» - любое действие (операция) или совокупность действий (операций), совершаемых с использованием средств автоматизации или без использования таких средств с персональными данными, включая сбор, запись, систематизацию, накопление, хранение, уточнение (обновление, изменение), извлечение, использование, передачу (распространение, предоставление, доступ), обезличивание, блокирование, удаление, уничтожение персональных данных.</p>
                        <p>1.4. «Конфиденциальность персональных данных» - обязанность Сервисного Центра не допускать распространения персональных данных без согласия Пользователя. В качестве исключения выступает требования предоставить персональные данные на законных основаниях.</p>
                        <p>1.5. «Пользователь сайта» (далее - Пользователь) – дееспособное физическое или юридическое лицо, заключившее с Сайтом Пользовательское соглашение, а также имеющее доступ к Сайту и использующее Сайт Сервисного центра посредством сети Интернет.</p>
                        <p>1.6. «Пользовательское соглашение» - общепринятые для всех Пользователей правила и детализированные условия пользования Сервисом Сайта.</p>
                        <p>1.7. «Сервисы сайта» - все услуги, которые оказывает Сайт, услуги заказанные на полях сайта, посредством письменных договоров в пункте приема и по телефону.</p>
                        <h4>2. Общие положения</h4>
                        <p>2.1. Настоящий документ (далее - Политика) определяет цели и общие принципы обработки персональных данных, а также реализуемые меры защиты персональных данных на Сайте сервисного центра.</p>
                        <p>2.2. Политика разработана в соответствии с положением п. 2 ч. 1 ст. 18.1 Федерального закона от 27 июля 2006 г. № 152-ФЗ «О персональных данных» и содержит общедоступную информацию, которая подлежит раскрытию в соответствии с ч. 1 ст. 14 ФЗ «О персональных данных»</p>
                        <p>2.3. Действие Политики распространяется на все персональные данные субъектов, которые обрабатываются Сайтом с использованием средств автоматизации и без их применения.</p>
                        <p>2.4. Сервисный центр не проверяет достоверность персональных данных, предоставляемых Пользователями, и не несет ответственности за действия других сервисных центров.</p>
                        <h4>3. Цели сбора и обработки персональной информации Пользователя</h4>
                        <p>3.1. Сайт собирает и хранит персональные данные, необходимые для оказания услуг Сервиса Пользователю.</p><p>3.2. Персональные данные Пользователя могут быть использованы в следующих целях:</p>
                        <p>3.2.1. Регистрация/Авторизация Пользователя на Сайте</p>
                        <p>3.2.2. Обработка Заказов Пользователя</p>
                        <p>3.2.3. Анализ функционирования Сервисного центра</p>
                        <p>3.2.4. Предоставления пользователю новостей и рекламной информации, путем рассылки сообщений на контактный номер или адрес электронной почты (отказаться от рассылки можно, отправив письменное уведомление).</p>
                        <h4>4. Сроки и способы обработки и хранения персональной информации</h4>
                        <p>4.1. Обработка персональных данных Пользователя осуществляется без срока ограничения и любым законным способом, в том числе при помощи средств автоматизации или без использования таких средств. При обработке персональных данных, Сайт принимает все необходимые меры для их защиты от неправомерного использования или получения сторонними лицами.</p>
                        <p>4.2. Персональные данные могут быть переданы уполномоченным органам государственной власти РФ, на основании и в порядке, установленным законодательством РФ.</p>
                        <h4>5. Согласие Пользователя</h4>
                        <p>5.1. При предоставлении персональных данных Пользователь дает согласие на обработку, хранение и использование своих персональных данных на основании федерального закона № 152-ФЗ «О персональных данных» от 27.07.2006 г. в следующих целях: регистрации Пользователя на сайте; осуществление поддержки клиентов; получения Пользователем новостей о маркетинговых мероприятиях; выполнение Сайтом обязательств перед Пользователем; анализ с целью повышения качества предоставляемых услуг.</p>
                        <p>5.2. Пользователь подтверждает, что персональные данные (ФИО, контактный номер, адрес электронной почты, адрес доставки) необходимые при заказе услуг, внесены на добровольной основе и являются достоверными.</p>
                        <p>5.3. В случае недостоверности персональных данных или неправомерных действиях, Сайт блокирует персональные данные Пользователя, с момента обращения Пользователя или уполномоченного законодательного лица по защите прав субъекта.</p>
                        <p>При использовании Сервисов Сайта и его материалов, Пользователь подтверждает, что ознакомлен с Политикой персональной информации и согласен со всеми перечисленными пунктами.</p>
                        <h4>6. Заключительные положения</h4>
                        <p>6.1. Сайт оставляет за собой право вносить изменения в одностороннем порядке в Политику, при условии, что изменения не выходят за рамки законодательства РФ. Изменения условий Политики вступают в силу после их публикации на Сайте.</p>
                        <p>6.2. Новая политика конфиденциальной информации и обработки персональных данных вступает в силу с момента размещения на Сайте.</p>
                        <p>6.3. К настоящей политике конфиденциальной информации и обработки персональных данных, а также отношениям между Пользователем и Сервисным Центром применяется действующее законодательство Российской Федерации.</p>
                    </div>
                </div>
            </div>
