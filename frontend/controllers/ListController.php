        ...
        if (count($url) > 1) {
            ...
            if ($page['type'] == 'brand' || $page['type'] == 'model') {
                ...
                if ($pageInfo['type'] == 2) {
                    ...
                    if ($siteConfig['id'] == 51) {
                        $title = 'Услуга: ' . $this->mb_ucfirst($pageInfo['title'], 'UTF-8') . ' ' . $page['title'];
                        $metaDesc = 'Качественная ' . $pageInfo['title'] . ' кофемашин ' . $page['title'] . ' в сервисном центре Кофе-Хелп в ' . Yii::$app->session['region']['titleRod'] . '. Фирменные комплектующие. Гарантия. Работаем ежедневно.';
                    } else {
