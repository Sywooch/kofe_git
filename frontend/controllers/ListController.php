            ...
            if ($pageInfo['type'] == 2) {
                ...
                if ($siteConfig['mono']) {
                    ...
                    if (isset($siteConfig['theme']) && $siteConfig['theme'] == 'hepler') {
                        ...
                        $seoH1 = [
                            91 => 'кофемашина  не подаёт воду',
                            92 => 'кофемашина не варит кофе',
                            93 => 'кофемашина протекает',
                            96 => 'кофемашина не нагревает воду',
                            97 => 'у кофемашины ошибка на дисплее',
                            118 => 'кофемашина готовит слишком горячий или холодный кофе',
                            119 => 'кофемашина не мелет кофе',
                            120 => 'кофемашина не подаёт пар',
                            121 => 'кофемашина не включается',
                            122 => 'кофемашина не подаёт пену',
                            123 => 'кофемашина готовит слабый или не вкусный кофе',
                            124 => 'в кофемашине плохо течет кофе',
