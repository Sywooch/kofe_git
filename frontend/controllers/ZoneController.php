...
//        ]);
        ...
        elseif ($siteConfig['id'] == 49) {
            $metaDesc = 'Сломалась кофемашина? Обращайтесь в ' . $_SERVER['HTTP_HOST'] . '! Опытные инженеры продиагностируют устройство и выполнят ремонт кофемашины в кратчайшие сроки!';
        } else
