...
$(document).ready(function() {
    ...
    var map = (function() {
        ...
        var tabID = tabLinks.filter('.active').data('target');
        if (!tabID) tabID = 'tab1';
        var json;
        var container = document.querySelector('.mm-bg .container-fluid');
        "/assets/jsonmodels/city.json"
        ...
        return {
            init: function() {
                load("/assets/jsonmodels/city.json").done(function(data) {
                    json = data;
                    var src = data[tabID]["src"];
                    createScript(src);
                }).fail(function() {
