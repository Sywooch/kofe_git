...
if(f <= 0) {
    ...
    f = e.getTime() / 1000 - d.getTime() / 1000;    
}
...
$(document).on('ready', function () {
    ...
    $('.close').on('click', function () {
        ...
        $('.thenks').removeClass('state-appear');
        $modal.removeClass('state-appear');
        $('.open-email-form').removeClass('state-appear');
    });
    ...
    $('.open-email').on('click', function () {
        $overlay.addClass('state-show');
        $('.open-email-form').removeClass('state-leave').addClass('state-appear');
        return false;
    });

    $('.gifts').on('click', function () {
        $overlay.addClass('state-show');
        $('.thenks').removeClass('state-leave').addClass('state-appear');
        $('.gift').hide()
        return false;
    });
